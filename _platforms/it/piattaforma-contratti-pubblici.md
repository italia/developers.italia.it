...
subtitle: Portale unico per l’interoperabilità dell’ecosistema nazionale di approvvigionamento digitale
...
([Decreto legislativo 31 marzo 2023, n. 36](https://www.gazzettaufficiale.it/dettaglio/codici/contrattiPubblici)).
...
[portale ANAC dedicato](https://dati.anticorruzione.it/opendata).
...
1. figurare nel Registro delle Piattaforme Certificate come Gestori autorizzati,
   ...
   ([Nuova sezione dedicata](https://www.agid.gov.it/it/piattaforme/procurement/certificazione-componenti-piattaforme)).
...
2. aver effettuato l’adesione a PDND, che per i soggetti non iscritti a IPA
   ...
   essere effettuata in autonomia sul [portale dedicato](https://www.interop.pagopa.it).
...
Utilizza [https://github.com/anticorruzione/npa](https://github.com/anticorruzione/npa)
per esplorare le specifiche tecniche, aprire una issue o una segnalazione.

<a class="btn btn-primary" href="https://github.com/anticorruzione/npa" target="_blank" ><svg class="icon icon-white p-1 mr-1"><use xlink:href="/assets/svg/sprite.svg#it-github"></use></svg>
  Vai a GitHub
</a>
