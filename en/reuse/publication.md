...
2. include the repository URL [in the list](https://github.com/italia/developers-italia-backend/blob/main/publishers.thirdparty.yml) by opening a pull request on GitHub.
