...
<a class="btn btn-outline-primary" href="https://docs.italia.it/docs/policy-inserimento-catalogo-docs/it/stabile/"><i class="it-file" /> Regolamento del catalogo software</a>
