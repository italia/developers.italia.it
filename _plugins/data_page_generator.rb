...
module Jekyll
  ...
  class DataPage < Page
    ...
    def initialize(site, base, index_files, dir, data, name, template, extension, lang)
      @site = site
      @base = base
        ...
        data.each do |data_spec|
          ...
          if site.layouts.key? template
            ...
            records.each do |record|
              site.pages << DataPage.new(site, site.source, index_files_for_this_data, dir, record, name, template, extension, lang)
            end
          else
